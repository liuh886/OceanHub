...
export const ccsInfrastructureCases: ReferenceCase[] = [
  ...
  },
  {
    ...
    evidence: [{ id: 'porthos-platform-well-conversion', discipline: 'wells', uncertainty: 'Legacy production wells and platform systems were not originally designed for CO2 injection service.', evidenceNeeded: 'Condition, conversion and monitoring evidence covering wells, platform process paths and remote control.', methods: ['Brownfield platform survey','Well conversion engineering','Tubing replacement','Pressure and temperature instrumentation','Remote-control integration'], capabilities: ['Brownfield offshore engineering','Well conversion','CO2 materials and integrity','Instrumentation and control','Injection surveillance'], deliverables: ['Conversion design basis','Well modification package','Instrumentation architecture','Operational monitoring plan'], referenceIds: ['iso-27914-2026','iso-27913-2024','dnv-rp-j203'], rationale: 'Porthos is converting the former gas-production platform and wells and installing pressure and temperature monitoring for injection.', sourceIds: ['porthos-project','porthos-platform-wells-2025'] }],
