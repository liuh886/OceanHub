...
export const windSiteCasesA: ReferenceCase[] = [
  {
    ...
    evidence: [{ id: 'vineyard-metocean', discipline: 'metocean', uncertainty: 'Site conditions vary spatially and seasonally.', evidenceNeeded: 'Atmospheric and oceanographic observations for model calibration and design-basis work.', methods: ['Floating LiDAR', 'Wave/current measurement', 'Metocean QA/QC'], capabilityIds: ['metocean-observation-analysis'], deliverables: ['Validated time series', 'Wind/wave/current statistics'], referenceIds: ['iso-19901-1-2015', 'dnv-rp-c205'], rationale: 'BOEM records floating LiDAR and seabed wave/current measurement for this site.', sourceIds: ['vineyard-mid-atlantic-boem'] }],
