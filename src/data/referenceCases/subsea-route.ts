...
export const subseaRouteCases: ReferenceCase[] = [
  ...
  },
  {
    ...
    evidence: [{ id: 'ormen-template-installation', discipline: 'marine-operations', uncertainty: 'Heavy subsea lifts are sensitive to vessel motion, rigging, position and seabed landing conditions.', evidenceNeeded: 'Installation analysis and real-time positional evidence for the lift and landing operation.', methods: ['Lift analysis', 'Installation simulation', 'Seabed mapping', 'Acoustic positioning'], capabilities: ['Heavy lift engineering', 'Subsea structures', 'Marine simulation', 'Acoustic positioning'], deliverables: ['Lift plan', 'Installation simulation', 'Landing/position record', 'As-installed survey'], referenceIds: ['dnv-st-n001', 'dnv-rp-0002'], rationale: 'The Ormen Lange template installation used extensive simulation, seabed mapping and acoustic positioning for deepwater placement.', sourceIds: ['ormen-templates'] }],
